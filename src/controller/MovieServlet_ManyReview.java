...
@WebServlet("/ManyReview-movie")
public class MovieServlet_ManyReview extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.getRequestDispatcher("goManyReview.jsp").forward(request, response);
    }
}
