...
<body>
    <div class="container">
        ...
        <h2 align="center">회원메뉴</h2>
        <form name="mem">
        <input type="hidden" name="t_gubun">
            <button type="button" id="button1" onclick="goMemberInfo()">내 정보</button>
            <button type="button" id="button1" onclick="goSaveMovieList()">저장한 영화</button>
            <button type="button" id="button1" onclick="goSaveRatingList()">작성한 리뷰</button>
        </form>
    </div>
<script>
